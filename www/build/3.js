...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__products__ = __webpack_require__(715);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_product_product__ = __webpack_require__(352);
    ...
    ProductsPage.prototype.getProductsFromServer = function () {
        ...
        this.productService.getProducts()
            ...
            if (res == "error") {
                ...
                loading.dismiss();
                return _this.utility.showAlert("Error", "Something went wrong, Products didnt fetch from server");
            }
            else {
